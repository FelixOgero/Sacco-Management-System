      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ url('admin/dividends/edit/'.$getRecord->id) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  .replace(/[^0-9]/g, ''); if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" value="{{ $getRecord->accumulated_amount }}">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  .replace(/[^0-9]/g, ''); if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" value="{{ $getRecord->amount }}">
                </div>
              </div>
