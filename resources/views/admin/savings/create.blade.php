  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Loan Saving</h5>

            <!-- General Form Elements -->
            <form action="{{ url('admin/savings/add') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input required type="text" name="tax_id" class="form-control">
