...
<div class="pagetitle">
    <h1>New Withdrawal Application</h1>
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ url('admin/withdrawals/add') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input required type="text" name="payment_method" class="form-control">
                </div>
              </div>
              ...
              {{-- <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input required type="text" name="reference_number" class="form-control">
                </div>
              </div> --}}
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input readonly value="400" required type="number" name="transaction_fee" class="form-control" oninput="javascript: this.value = this.value
