      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{ url('admin/payments/add') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      ...
                      .replace(/[^0-9]/g, ''); if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="16">
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" name="staff_id" required>
                        ...
                        <option value="{{ $value_4->id }}">{{ $value_4->name }} {{ $value_4->last_name }} {{ $value_4->surname }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" name="loan_plan_id" required>
                        ...
                        @foreach($getLoanPlan as $value_2)
                            <option value="{{$value_2->id}}">{{$value_2->months}} [ {{ $value_2->interest_percentage .'% '. $value_2->penalty_rate}} ]</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
